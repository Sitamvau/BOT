...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("সিতাম বস আপনি  কাকে চুদতে চান এমন 1 জনকে @ম্যানশন করতে হবে", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("সিতাম এর চুদা লো");
setTimeout(() => {a({body: "সিতাম এর পোলা তর মারে চুদি 🥰।" + " " + name, mentions: arraytag})}, 3000);
...
setTimeout(() => {a({body: "সিতামের নুনুর যোগ্যতা আছে বান্দি মাগির পোলা তর আম্মু রে চুদি তর দুলা ভাই এর কান্দে ফেলে  🤝" + " " + name, mentions: arraytag})},23000);
...
setTimeout(() => {a({body: "Hi সিতাম এর  জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi সিতাম এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ সিতাম এর  পুত। জা ভাগ🤖")} , 39000);
